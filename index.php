...
<body>
  ...
  <!-- ================ start banner Area ================= -->
  <section class="home-banner-area banner banner-index">
    <div class="container">
      <div class="row justify-content-center fullscreen align-items-center">
        <div class="col-md-8 dashboard-banner-left">
          <h1 class="text-white font-judul">
            Yuk Belajar Robotik <br />
            untuk Indonesia <br/>
			      Lebih Baik
          </h1>
          <p class="mx-auto text-white  mt-20 mb-40 font-judul">
            TeSchool merupakan platform untuk Belajar <br/>
			      Robotik, dari Indonesia, oleh Indonesia <br/>
			      Untuk Indonesia
          </p>
        </div>
