				...
				<?php
					echo "<div class=\"single-popular-course\">";
						echo "<div class=\"thumb\">";
							echo "<img class=\"f-img img-fluid mx-auto\" src=\"img/popular-course/p1.jpg\" alt=\"\" />";
						echo "</div>";
						echo "<div class=\"details\">";
							echo "<div class=\"d-flex justify-content-between mb-20\">";
								echo "<p class=\"name\">programming language</p>";
								echo "<p class=\"value\">$150</p>";
							echo "</div>";
							echo "<a href=\"#\">";
								echo "<h4>Learn Angular JS Course for Legendary Persons</h4>";
							echo "</a>";
							echo "<div class=\"bottom d-flex mt-15\">";
								echo "<ul class=\"list\">";
									...
									echo "</li>";
								echo "</ul>";
								echo "<p class=\"ml-20\">25 Reviews</p>";
							echo "</div>";
						echo "</div>";
					echo "</div>";
				?>
